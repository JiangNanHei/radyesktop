    ...
    <div>
        <div class="videos-dewatering-wrapper">
            <div class="d-monitoring-live">
                <p class="d-live-monitoring-title">提取视频</p>
                <span class="d-live-monitoring-desc">可以对淘宝商品主页视频提取的操作，本平台只提供工具，请不要擅自商用，若发生侵权，本平台对此不承担责任</span>
                <div class="demo-input-suffix">
                    <div class="search_box">
                        <el-input
                            v-model = "videotablsearch"
                            placeholder="请输入淘宝宝贝分享地址链接"
                            >
                        </el-input>
                    ...
                    <el-popover
                        ...
                        <div slot="reference" class="d-monitoring-question">
                             ...
                             <span class="d-monitoring-question-desc">如何获取淘宝宝贝链接</span>
                        </div>
                    </el-popover>
    ...
    export default {
        ...
        methods: {
            ...
            searchResult() {
                const _this = this
                this.$http({
                    url: "/tool_extract_video_detailed.json",
                    method: "GET",
                    data : this.$http.adornParams({
