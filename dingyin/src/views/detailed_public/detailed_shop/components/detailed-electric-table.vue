<template>
    <div class="table_box">
        ...
        <el-table :data="towtableData.slice((currpage -1) * pagesize, currpage * pagesize)"
            ...
            <el-table-column sortable align="center" label="佣金比例" prop="three">
                <template slot-scope="scope">
            ...
            <el-table-column sortable align="center" label="关联直播" prop="six_live"></el-table-column>
...
<script>
    export default {
        ...
        props: ['classification_data','towtableData'],
        data() {
            return {
                // 搜索框input
                videotablsearch: '',
