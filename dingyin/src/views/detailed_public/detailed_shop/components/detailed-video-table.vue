<template>
    <div>
        ...
        >
            <el-table-column min-width="200px" align="center" label="视频内容">
            ...
            <el-table-column min-width="130px" align="center" label="达人">
                <template slot-scope="scope">
                    <div class="columntow">
                        <div class="userImg2">
                            <img :src="scope.row.talent_content.imgurl">
                        </div>
                        <div class="userName">
                            <p>{{scope.row.talent_content.title}}</p>
                        </div>
                    </div>
                </template>
            </el-table-column>
            <el-table-column sortable align="center" label="点赞数" prop="give">
                <template slot-scope="scope">
                    {{scope.row.give}}<span>W</span>
                </template>
            </el-table-column>
            <el-table-column sortable align="center" label="评论数" prop="comment"></el-table-column>
             <el-table-column sortable align="center" label="分享数" prop="share"></el-table-column>
