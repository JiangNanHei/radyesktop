<template>
    <div>
        ...
        >
            <el-table-column min-width="160px" align="center" label="商品">
                <template slot-scope="scope">
                    <div class="columntow">
                        ...
                        <div class="userName">
                            <p><span>{{scope.row.video_content.title}}</span>{{scope.row.video_content.title_status}}</p>
                            <span>{{scope.row.video_content.release_time}}</span>
                        </div>
                    </div>
                </template>
            </el-table-column>
            <el-table-column align="center" label="直播达人" prop="talent_content"></el-table-column>
            <el-table-column sortable align="center" label="开播时间" prop="live_time"></el-table-column>
            <el-table-column sortable align="center" label="直播时长" prop="live_time_length"></el-table-column>
            <el-table-column sortable align="center" label="销量" prop="transpond">
                <template slot-scope="scope">
                    {{scope.row.transpond}}<span>W</span>
                </template>
            </el-table-column>
            <el-table-column sortable align="center" label="销售额" prop="sales_amount">
                <template slot-scope="scope">
                    {{scope.row.sales_amount}}<span>W</span>
                </template>
            </el-table-column>
            <el-table-column align="center" label="操作">
                <template>
                    <el-button type="primary" @click="goDetailedLive">直播详情</el-button>
                </template>
            </el-table-column>
        </el-table>
...
<script>
    export default {
        ...
        methods: {
            // table搜索框搜索按钮
            videotablebut(){
                console.log(this.videotablsearch)
