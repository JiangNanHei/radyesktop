<template>
    <div class="table_box">
        <!-- table 列表 -->
        <el-table v-infinite-scroll="load" infinite-scroll-disabled="disabled" :data="content" style="width: 100%"
        :tree-props="{children: 'children', hasChildren: 'hasChildren'}">
            <el-table-column min-width="170px" align="center" label="商品相关视频">
            ...
            <el-table-column min-width="100px" align="center" label="达人">
                <template slot-scope="scope">
            ...
            <el-table-column  align="center" label="点赞数" prop="five">
                <template slot-scope="scope">
                    <span>{{scope.row.thumbs_up}}</span>
                </template>
            </el-table-column>
            <el-table-column  align="center" label="评论数" prop="seven">
                <template slot-scope="scope">
                    <span>{{scope.row.comment}}</span>
                </template>
            </el-table-column>
            <el-table-column  align="center" label="分享数" prop="six">
                <template slot-scope="scope">
