        ...
        <el-row :gutter="10" class="d-basic-title">
            ...
            <el-col :span="24">
                <div class="grid-content bg-purple d-grid-show">
                    <p>每日播放量增长趋势</p>
                    <div class="d-electric-desc-item-echart">
                        <div class="d-myChartn d-myChartn-right" id="d-play-volume-data"  :style="{width: '100%', height: '250px'}"></div>
                    </div>
                </div>
            </el-col>
            <el-col :span="24">
...
import { echartsLine, echartsLine2, echartsPie} from '@/assets/js/echarts_self.js'
    ...
    methods: {
        getData() {
            ...
            this.$http({
                ...
                // 点赞数据--折线图
                echartsLine2(document.getElementById('d-play-volume-data'), data.play_volume.dataX, data.play_volume.dataY1)
                if(data.code == 200){
