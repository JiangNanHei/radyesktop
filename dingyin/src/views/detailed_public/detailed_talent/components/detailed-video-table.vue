<template>
    <div>
        ...
        >
            ...
            <el-table-column min-width="180px" align="center" label="操作" prop="saleroom">
                <template>
                    <div class="table_button_group">
                        <el-button type="primary" @click="goDetailvideo">视频详情</el-button>
                        <el-button type="primary">播放视频</el-button>
                    </div>
                </template>
            </el-table-column>
        </el-table>
