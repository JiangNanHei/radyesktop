<template>
    <div class="table_box">
        <el-row :gutter="20" class="d-basic-electric-list">
            <el-col v-for="(item,i) in overview_data" :key="i">
                <div class="grid-content bg-purple d-basic-electric-item">
                    <span class="d-electric-item-left">{{item.title}}</span>
                    <span class="d-electric-item-right">{{item.figure}}</span>
                </div>
            </el-col>
        </el-row>
        <!-- 搜索框 -->
        <div class="demo-input-suffix">
            <div class="search_box">
                <el-input v-model="videotablsearch" placeholder="请输入视频标题">
                </el-input>
            ...
            <el-table-column align="center" label="操作" prop="saleroom">
                <template>
                    <div class="table_button_group">
                        <el-button type="primary" @click="goDetailedcommodity">商品详情</el-button>
                    </div>
                </template>
            </el-table-column>
        </el-table>
