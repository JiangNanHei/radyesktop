<template>
    <div>
        ...
        >
            <el-table-column min-width="180px" align="center" label="直播场次">
            ...
            <el-table-column sortable align="center" label="开播时间" prop="release_time"></el-table-column>
            <el-table-column align="center" label="直播时长" prop="estimate_sales"></el-table-column>
            <el-table-column sortable align="center" label="人气峰值" prop="estimate_saleroom">
                <template slot-scope="scope">
                    {{scope.row.estimate_saleroom}}
                </template>
            </el-table-column>
            <el-table-column sortable align="center" label="礼物收入" prop="give">
                <template slot-scope="scope">
                    {{scope.row.give}}<span>W</span>
                </template>
            </el-table-column>
            <el-table-column sortable align="center" label="商品数" prop="comment"></el-table-column>
