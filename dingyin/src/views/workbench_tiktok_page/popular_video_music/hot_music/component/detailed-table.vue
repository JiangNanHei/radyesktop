<template>
    <div>
        <div class="demo-input-suffix">
            ...
            <span>音乐库共计{{total_data}}条音乐</span>
        </div>
        ...
        >
            ...
            <el-table-column min-width="120px" align="center" label="音乐">
                <template slot-scope="scope">
                    <div class="columntow">
                        <div class="userImg">
                        ...
                        <div class="userName">
                            ...
                            <div class="d-music-time">音乐时长 : {{scope.row.video_content.desc}}s</div>
                        </div>
                    </div>
                </template>
            </el-table-column>
            <el-table-column align="center" label="作者" prop="estimate_saleroom">
                <template slot-scope="scope">
                    {{scope.row.author}}
                </template>
            </el-table-column>
            <el-table-column sortable align="center" label="使用人数上升趋势" prop="give">
                <template slot-scope="scope">
            ...
            <el-table-column sortable align="center" label="总使用人数" prop="transpond">
                <template slot-scope="scope">
                    {{scope.row.user_number}}<span>W</span>
                </template>
            </el-table-column>
            ...
            <el-table-column align="center" label="操作">
                <div class="table_button_group">
                    <el-button type="primary" @click="goMusicdetailscreen">歌曲详情</el-button>
                    <el-button type="primary" >下载音乐</el-button>
                </div>
            </el-table-column>
        </el-table>
...
<script>
import detailedRadio from '@/components/page/douyin/detailed-radio'
    export default {
        components: {
            detailedRadio
        },
