<template>
    <div class="table_box">
        ...
        <el-table v-infinite-scroll="load" infinite-scroll-disabled="disabled" :data="tableData" style="width: 100%">
            ...
            <el-table-column align="center" label="排名趋势">
                <template slot-scope="scope">
                    <div class="ranking_trend">
                        <div v-if="scope.row.ranking_trend>=0" class="ranking_up">
                            <div class="triangle_box">
                                <div class="triangle"></div>
                            </div>
                            <div class="content">
                                上升{{scope.row.ranking_trend}}名
                            </div>
                        </div>
                        <div v-else class="ranking_down">
                            ...
                            <div class="content">
                                下降{{Math.abs(scope.row.ranking_trend)}}名
                            </div>
                        </div>
                    </div>
                </template>
            </el-table-column>
            <el-table-column align="center" label="涨粉数">
                <template slot-scope="scope">
                    <div class="rise_fans">
                        <span>{{scope.row.up_fans | NumToUnitNum}}</span>
                    </div>
                </template>
            </el-table-column>
            <el-table-column align="center" label="抖音粉丝">
                <template slot-scope="scope">
                    <span>{{scope.row.tik_tok | NumToUnitNum}}</span>
                </template>
            </el-table-column>
