<template>
    <div class="table_box">
        ...
        <el-table v-infinite-scroll="load" infinite-scroll-disabled="disabled" :data="tableData" style="width: 100%">
            ...
            <el-table-column align="center" label="土豪">
                <template slot-scope="scope">
                    <div class="columntow">
                        <div class="userImg">
            ...
            <el-table-column sortable align="center" label="送出音浪">
                <template slot-scope="scope">
                    <div class="rise_fans">
            ...
            <el-table-column sortable align="center" label="关联直播">
                <template slot-scope="scope">
                    <span>{{scope.row.relevance_live | NumToUnitNum}}</span>
                </template>
            </el-table-column>
            <el-table-column sortable align="center" label="关联达人">
                <template slot-scope="scope">
                    <span>{{scope.row.relevance_expert | NumToUnitNum}}</span>
                </template>
            </el-table-column>
