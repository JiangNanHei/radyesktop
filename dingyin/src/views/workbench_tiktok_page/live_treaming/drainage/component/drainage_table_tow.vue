<template>
    <div class="table_box">
        ...
        <el-table v-infinite-scroll="load" infinite-scroll-disabled="disabled" :data="tableData" style="width: 100%">
            ...
            <el-table-column align="center" label="达人">
                <template slot-scope="scope">
                    <div class="columntow">
                        ...
                        <div class="userName">
                            {{scope.row.expert.title}}
                        </div>
                    </div>
                </template>
            </el-table-column>
            <el-table-column align="center" label="达人粉丝数">
                <template slot-scope="scope">
                    <span>{{scope.row.fans | NumToUnitNum}}</span>
                </template>
            </el-table-column>
            <el-table-column sortable align="center" label="达人粉丝增量">
                <template slot-scope="scope">
                    <div class="ranking_trend">
                        <div v-if="scope.row.fans_add>=0" class="ranking_up">
                            <div class="triangle_box">
                                <div class="triangle"></div>
                            </div>
                            <div class="content">
                                {{scope.row.fans_add | NumToUnitNum}}
                            </div>
                        </div>
                        <div v-else class="ranking_down">
                            ...
                            <div class="content">
                                {{Math.abs(scope.row.fans_add) | NumToUnitNum}}
                            </div>
                        </div>
                    </div>
                </template>
            </el-table-column>
            <el-table-column align="center" label="PK达人">
                <template slot-scope="scope">
                    <div class="columntow">
                        <div class="userImg">
                            <el-image :src="scope.row.pk_expert.imgurl"></el-image>
                            
                        </div>
                        <div class="userName">
                            {{scope.row.pk_expert.title}}
                        </div>
                    </div>
                </template>
            </el-table-column>
            <el-table-column align="center" label="达人粉丝数">
                <template slot-scope="scope">
                    <span>{{scope.row.pk_fans | NumToUnitNum}}</span>
                </template>
            </el-table-column>
            <el-table-column sortable align="center" label="达人粉丝增量">
                <template slot-scope="scope">
                    <div class="ranking_trend">
                        <div v-if="scope.row.pk_fans_add>=0" class="ranking_up">
                            <div class="triangle_box">
                                <div class="triangle"></div>
                            </div>
                            <div class="content">
                                {{scope.row.pk_fans_add | NumToUnitNum}}
                            </div>
                        </div>
                        <div v-else class="ranking_down">
                            <div class="triangle_box">
                            ...
                            <div class="content">
                                {{Math.abs(scope.row.pk_fans_add) | NumToUnitNum}}
                            </div>
                        </div>
                    </div>
                </template>
            ...
            <el-table-column width="140px" align="center" label="操作">
                <div class="table_button_group">
                    <el-button type="primary" @click="liveparticulars">直播详情</el-button>
                </div>
            </el-table-column>
        </el-table>
