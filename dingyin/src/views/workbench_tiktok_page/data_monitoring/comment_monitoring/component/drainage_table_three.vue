        ...
        <div class="box">
            ...
            <div class="d-monitor-title">
                <div class="headeroption">
                    ...
                    <p class="d-commont-title-desc">剩余时间：<span>{{surplus_time}}</span></p>
                </div>
                <div>
                    <el-button type="primary" @click="dialogTableVisible = true">管理监控中账号</el-button>
                </div>
            </div>
            <el-dialog title="管理监控中账号" :visible.sync="dialogTableVisible" :modal="false">
                <p class="d-comment-adjinistration-title">目前监控中账号共有 <span>{{ialog_table_visible_number}}</span> 条</p>
...
export default {
    ...
    methods: {
        getData() {
            const _this = this
            this.$http({
                url: "/monitoring_comment_under_way.json",
                method: "GET",
                ...
                //监控剩余时长
                _this.surplus_time = data.surplus_time
