<template>
    <div>
        <div class="monitoring-comment-wrapper">
            <div class="d-monitoring-live">
                <p class="d-live-monitoring-title">添加监控抖音号</p>
                <div class="demo-input-suffix">
                    <div class="search_box">
                        <el-input
                            v-model = "videotablsearch"
                            placeholder="请输入抖音昵称、抖音号、主页链接进行搜索"
                            >
                        </el-input>
...
<script>
    ...
    import detailedHomelinks from "../../components/detailed-homelinks"
    export default {
        components: {
            monitoringRadio,
            detailedRecharge,
        ...
        methods: {
            ...
            searchResult() {
                const _this = this
                this.$http({
                    url: "/monitoring_comment_search.json",
                    method: "GET",
                    data : this.$http.adornParams({
